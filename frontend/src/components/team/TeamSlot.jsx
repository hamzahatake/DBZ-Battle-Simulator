...
import { removeCharacterFromTeam } from '../../features/teams/teamsSlice';
            ...
            {character && (
                <>
                    ...
                    <div className="h-[70%] flex items-center justify-center">
                        <img
                            src={getImageUrl(character.full_body_image_url)}
                            alt={character.name}
                    ...
                    <button
                        onClick={(e) => {
                            if (user?.id) {
                                dispatch(removeCharacterFromTeam({ characterId: character.id, userId: user.id }));
                            }
                        }}
