...
import HeroCover from "/images/HeroCover1.jpg";

export default function HeroBanner() {
    return (
        <div
            className="relative w-full min-h-screen flex items-center justify-center px-6 text-white overflow-hidden bg-cover bg-center bg-fixed"
