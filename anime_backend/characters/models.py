...
class Character(models.Model):
    ...
    special_move = models.CharField(max_length=100, blank=True, null=True)
    ultimate_move = models.CharField(max_length=100, blank=True, null=True)
    strengths = models.CharField(max_length=100, blank=True, null=True)
    weaknesses = models.CharField(max_length=100, blank=True, null=True)
